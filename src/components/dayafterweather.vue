    ...
    getWeather() {
      ...
      axios
        ...
        .then(response => {
          ...
          this.temps = response.data.list[16].main.temp;
          this.dates = response.data.list[16].dt_txt.slice(0, 10);
          console.log(this.dates.slice(0, 10));
          this.forecastText = this.dates;
          this.overcast = response.data.list[16].weather[0].main;
          // this.dates = new Date(this.dates * 1000)
          //   .toLocaleTimeString("en-GB")
          //   .slice(0, 4);
          // console.log(this.dates.slice(0, 10));

          // this.overcast = response.data.list.weather.main;
          // this.weatherType = response.data.list[8].weather.main;
          // console.log(this.response.data.list[8].weather.main);
          // this.icon =
